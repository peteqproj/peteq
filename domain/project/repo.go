...
`
var queries = []string{
	"CREATE TABLE IF NOT EXISTS repo_project ( id text not null,userid text not null,info json not null,PRIMARY KEY (id));",
	"CREATE INDEX IF NOT EXISTS userid ON repo_project ( userid);",
}
